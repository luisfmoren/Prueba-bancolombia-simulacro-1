...
public class PersonalInformation implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(PersonalInformationPage.BUTTON_SINGIN),
                ...
                Enter.theValue(email).into(PersonalInformationPage.INPUT_EMAIL),
                SelectFromOptions.byVisibleText(month).from(PersonalInformationPage.DROPDOWN_MONTH),
                SelectFromOptions.byVisibleText(day).from(PersonalInformationPage.DROPDOWN_DAY),
                SelectFromOptions.byVisibleText(year).from(PersonalInformationPage.DROPDOWN_YEAR),
